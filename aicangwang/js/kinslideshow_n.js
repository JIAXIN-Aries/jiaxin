	...
	$.fn.KinSlideshow = function(settings) {
		...
		function KSS_setBtn() {
			...
			if (settings.isHasBtn && KSS_imgaeLength >= 2) {
				$(ksthis).append("<div class='KSS_btnBox' ></div>");
				var KSS_btnList = "";
				...
				$(ksbs + " .KSS_btnBox").append(KSS_btnList);
				 $(ksbs + " .KSS_btnBox #btnlistID li").addClass('link');
				...
				// });
				$(ksbs + " #btnlistID li:eq(0)").addClass(settings.btn.btn_class);
				// .css({
		...
		function setTiltFontShow(index) {
			...
			$(ksbs + " #btnlistID li").each(function(i) {
				if (i == index) {
					$(this).addClass(settings.btn.btn_class);
					// .css({
					// 	background: settings.btn.btn_bgHoverColor,
					// 	borderColor: settings.btn.btn_borderHoverColor,
					// 	color: settings.btn.btn_fontHoverColor
					...
					$(this).removeClass(settings.btn.btn_class);
					// .css({
					// 	background: settings.btn.btn_bgColor,
					// 	borderColor: settings.btn.btn_borderColor,
					// 	color: settings.btn.btn_fontColor
